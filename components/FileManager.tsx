              ...
              <div className="flex-1 flex flex-col p-8 overflow-y-auto">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <div className="flex gap-2">
                    <button className="size-10 flex items-center justify-center relative chamfer-sm chamfer-border bg-cds-interactive/40 before:bg-cds-interactive/10 text-cds-interactive">
                      <span className="material-symbols-outlined text-xl">grid_view</span>
                    </button>
                    <button className="size-10 flex items-center justify-center relative chamfer-sm chamfer-border bg-cds-border/20 before:bg-black/40 text-cds-text-04 hover:text-cds-text-02 transition-all">
